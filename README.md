...
The template is configured to use SQLite by default. If you would prefer to use Server Express LocalDb, create your solution using the following command:

```bash
dotnet new ca-sln --use-local-db
```
